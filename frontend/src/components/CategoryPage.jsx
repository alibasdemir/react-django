...
function CategoryPage() {
      ...
      try {
        ...
        if (categoryId === "all") {
          const allCategory = {
            ...
            img_url:
              "https://idsb.tmgrup.com.tr/ly/uploads/images/2023/01/22/thumbs/800x531/252949.jpg",
          };
  ...
  const handleFilter = (type, id) => {
    if (
      (type === "location" &&
        !filterEvents.every((event) => event.location === id)) ||
      ...
      <div className="p-4 sm:p-6 lg:p-10 bg-gray-100">
        <div className="ml-[1.5rem] mr-[1.5rem]">
          <div className="mb-6 mt-3 lg:mb-12">
            <div className="flex flex-col md:flex-row justify-between items-center border-b border-indigo-500 mb-1 px-4 ">
              <h2 className="text-start font-bold text-blue-900 md:text-center md:mb-0">
                {categoryTitle}
              </h2>
              <div className="flex flex-row text-blue-900 pt-3">
                ...
                <Link
                  to="/"
                  className="text-blue-900 no-underline mr-2 hover:text-blue-600"
                >
                  Anasayfa
                </Link>
                <span
                  style={{ width: "5px", height: "5px", borderRadius: "50%" }}
                  className="bg-blue-900 md:hidden mt-2.5"
                ></span>
                <p className="ml-2 hidden md:block">{categoryTitle}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between ">
            ...
            <div className="w-auto h-auto mt-4">
              <div className="bg-gray-200 p-4 rounded-2xl lg:mx-20">
                <div className="filter-div flex lg:flex-row flex-col bg-white/75 rounded-2xl shadow-lg shadow-indigo-500/50 justify-around">
                  <div className="owner flex flex-col lg: px-6 m-2 border-r border-indigo-300 py-3">
                    <h5 className="text-blue-600 flex items-center text-lg mb-2">
                      Tarih
                    </h5>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="clear-btn">
                          <button
                            ...
                            onClick={handleClear}
                          >
                            <MdClear className=" text-lg mr-1" /> Filtreleri
                            Temizle
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="location flex flex-col px-2 m-2  items-center">
                    <h5 className="text-blue-600  text-base mb-2 border-b border-indigo-400">
                      Konum
                    </h5>
                    <ul className="p-0 flex flex-col gap-2">
                      {Object.entries(locationCount).map(
                        ([location, count]) => (
                          <li
                  ...
                  <div className="owner flex flex-col pr-2 pl-2 m-2  items-center">
                    <h5 className="text-blue-600 flex  text-base mb-2 border-b border-indigo-400">
                      Mekan
                    </h5>
                      ...
                      <div className="flex justify-center items-center">
                        {new Date(event.end_date) < new Date() ? (
                          ...
                          <a
                            ...
                            className="text-indigo-800 no-underline text-md rounded-3xl font-bold h-10 w-48 bg-indigo-100 mb-3 mt-1 flex flex-row justify-center items-center hover:bg-indigo-500 hover:ease-out duration-500 hover:text-white hover:scale-105 "
                          >
                            Etkinlik Detayı
                          </a>
                        )}
                        ...
                        <div
                          className="text-center border rounded-full p-2 bg-gradient-to-r from-purple-500 via-blue-500 to-purple-500 ml-2"
                          onClick={() =>
                            new Date(event.end_date) >= new Date() &&
