...
export default function DiscoverBar() {
  ...
  <div className= "flex flex-row justify-evenly " style={{backgroundColor: 'white', paddingTop: 10, paddingBottom: 10, boxShadow: "0px 4px 4px 0px #a5b4fc" }}>
    <Box sx={{ width: 300, }}>
      ...
      <FormControl fullWidth>
        ...
        <NativeSelect style={{color: "#1976d2", fontSize: '12px'}}
  ...
  style={{
    ...
    transition: "all 0.3s ease", // Adding a transition for smooth animation
