                  ...
                  <div className='flex flex-row space-x-8'>
                    ...
                    <div>
                      ...
                      {new Date(event.end_date) < new Date() && (
                        <div className=" mt-4 mr-2 bg-red-500 p-2 text-white font-bold rounded-md text-sm hover:scale-110 cursor-pointer hover:bg-red-500 transition-colors ease-in-out duration-500 animate-pulse " style={{ cursor: 'default' }}>
