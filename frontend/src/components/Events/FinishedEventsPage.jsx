  ...
  return (
    <div>
      ...
      <div className='bg-gray-100 px-6 md:px-20 py-10'>
        <div className='bg-white px-4 md:px-20 py-4 md:py-10 rounded-2xl' style={{ boxShadow: '0 4px 8px #cbd5e1' }}>
          <div className='pb-4 md:pb-8 flex flex-row items-center space-x-1'>
            <Link to="/" className='no-underline hover:scale-105'>
              <BiSolidHome className='text-xl md:text-2xl mr-1 mb-2 text-rose-500 hover:text-rose-500' />
            </Link>
            <Link to="/categories/all" style={{ textDecoration: 'none' }} className="flex items-center">
              <RiArrowRightSLine className='text-xl md:text-2xl text-indigo-500' />
              <span className='text-indigo-500 no-underline mb-0.5'>Etkinlik</span>
            </Link>
            <RiArrowRightSLine className='text-xl md:text-2xl text-indigo-500' />
            <span className='text-rose-500 text-lg md:text-xl font-bold'>Süresi Geçen Etkinlikler</span>
          </div>

          <div>
            <div className=''>
              {events.map(event => (
                <div key={event.id} className='mb-4 md:mb-6 flex flex-col md:flex-row border border-gray-700 p-3 md:p-6 rounded-2xl space-x-0 md:space-x-4 justify-between ' style={{ boxShadow: '0 4px 8px #cbd5e1' }}>
                  <div className='flex flex-col lg:flex-row md:space-x-8'>
                    ...
                    <div> 
                      <span className='text-lg md:text-xl text-indigo-700 font-bold '>{event.name}</span>
                      {new Date(event.end_date) < new Date() && (
                        <div className=" mt-2 md:mt-4 bg-red-500 p-2 text-white font-bold rounded-md text-sm hover:scale-110 cursor-pointer hover:bg-red-500 transition-colors ease-in-out duration-500 animate-pulse " style={{ cursor: 'default' }}>
                  ...
                  <div className='mt-4 md:mt-0'>
                    <div className='flex flex-col md:flex-row md:space-x-8'>
                      <div className='flex flex-col p-3 md:space-y-2'>
